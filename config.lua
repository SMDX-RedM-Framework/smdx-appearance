...
SMDX.WelcomeText = "WELCOME TO SMDX FRAMEWORK"
...
SMDX.CameraPromptText = 'Up/Down'
SMDX.RotatePromptText = 'Left/Right'
SMDX.ZoomPromptText = 'Zoom'
SMDX.GroupPromptText = 'SMDXCore Creator'
...
SMDX.Texts = {
    ...
    Angle = "Angle",
    Clarity = "Clarity",
    Color1 = "<img src='nui://smdx-appearance/img/skin1.png' height='20'>",
    Color2 = "<img src='nui://smdx-appearance/img/skin2.png' height='20'>",
    Color3 = "<img src='nui://smdx-appearance/img/skin3.png' height='20'>",
    Color4 = "<img src='nui://smdx-appearance/img/skin4.png' height='20'>",
    Color5 = "<img src='nui://smdx-appearance/img/skin5.png' height='20'>",
    Color6 = "<img src='nui://smdx-appearance/img/skin6.png' height='20'>",
...
SMDX.Cloakroomtext = 'Open Changing Rooms'
SMDX.BlipName = 'Clothing Store' -- Blip Name Showed on map
SMDX.BlipNameCloakRoom = 'Wardrobe' -- Blip Name Showed on map
SMDX.BlipSprite = 1195729388	 -- Clothing shop sprite
SMDX.BlipSpriteCloakRoom = 1496995379	 -- Clothing shop sprite
SMDX.BlipScale = 0.2 -- Blip scale
SMDX.OpenKey = 0xD9D0E1C0 -- Opening key hash
SMDX.Keybind = 'ENTER' -- keybind
SMDX.ShowPlayerBucket = true -- prints to server the player routing bucket
